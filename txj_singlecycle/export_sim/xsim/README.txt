...
#
# Generated by export_simulation on Tue Aug 31 10:13:15 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './pip_cpu.sh' script.

./pip_cpu.sh -reset_run
...
./pip_cpu.sh -noclean_files

For more information on the script, please type './pip_cpu.sh -help'.
